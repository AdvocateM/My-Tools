...
def getmac(ip):
	...
	# scapy.srp to send the packet in layer2 Ether frame which returns 2 value answered,unanswered
...
spoof("192.168.43.16", "192.168.43.1")
# telling client I am the router

spoof("192.168.43.1", "192.168.43.16")
